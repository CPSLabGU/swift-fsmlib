...
//
#ifndef LLFSM_COUNTER_INITIAL_H
#define LLFSM_COUNTER_INITIAL_H
...
#define MACHINE_COUNTER_STATE_INITIAL_NUMBER_OF_TRANSITIONS 1
...
struct FSMCounter_State_Initial
{
