...
set(SuspendCounter_ARRANGEMENT_INCDIRS
  ...
  $<BUILD_INTERFACE:${CMAKE_CURRENT_SOURCE_DIR}/Suspend.machine/include>
  $<BUILD_INTERFACE:${CMAKE_CURRENT_SOURCE_DIR}/Suspend.machine>
...
set(SuspendCounter_ARRANGEMENT_INSTALL_INCDIRS
  ...
  $<INSTALL_INTERFACE:include/fsms/SuspendCounter.arrangement/Suspend.machine>
  $<INSTALL_INTERFACE:fsms/SuspendCounter.arrangement/Suspend.machine>
...
include(${CMAKE_CURRENT_LIST_DIR}/Suspend.machine/project.cmake)
foreach(src ${Suspend_FSM_SOURCES})
  list(APPEND SuspendCounter_ARRANGEMENT_FSMS "Suspend")
  list(APPEND SuspendCounter_ARRANGEMENT_FSM_Suspend_SOURCES Suspend.machine/${src})
  list(APPEND SuspendCounter_ARRANGEMENT_SOURCES Suspend.machine/${src})
endforeach()
