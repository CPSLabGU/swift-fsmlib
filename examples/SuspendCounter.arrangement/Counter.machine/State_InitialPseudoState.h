...
//
#ifndef LLFSM_COUNTER_INITIALPSEUDOSTATE_H
#define LLFSM_COUNTER_INITIALPSEUDOSTATE_H
...
struct FSMCounter_State_InitialPseudoState
{
...
#endif /* LLFSM_COUNTER_INITIALPSEUDOSTATE_H */
