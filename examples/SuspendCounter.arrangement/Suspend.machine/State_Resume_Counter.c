...
{
    state->check_transitions = (struct LLFSMState *(*)(const struct LLFSMachine *, const struct LLFSMState *))fsm_suspend_resume_counter_check_transitions;
    state->on_entry   = (void (*)(struct LLFSMachine *, struct LLFSMState *))fsm_suspend_resume_counter_on_entry;
    state->on_exit    = (void (*)(struct LLFSMachine *, struct LLFSMState *))fsm_suspend_resume_counter_on_exit;
    state->internal   = (void (*)(struct LLFSMachine *, struct LLFSMState *))fsm_suspend_resume_counter_internal;
    state->on_suspend = (void (*)(struct LLFSMachine *, struct LLFSMState *))fsm_suspend_resume_counter_on_suspend;
    state->on_resume  = (void (*)(struct LLFSMachine *, struct LLFSMState *))fsm_suspend_resume_counter_on_resume;
}
...
{
    (void)machine;
    return state->check_transitions == (struct LLFSMState *(*)(const struct LLFSMachine * const machine, const struct LLFSMState * const state))fsm_suspend_resume_counter_check_transitions &&
           state->on_entry   == (void (*)(struct LLFSMachine *, struct LLFSMState *))fsm_suspend_resume_counter_on_entry &&
           state->on_exit    == (void (*)(struct LLFSMachine *, struct LLFSMState *))fsm_suspend_resume_counter_on_exit &&
           state->internal   == (void (*)(struct LLFSMachine *, struct LLFSMState *))fsm_suspend_resume_counter_internal &&
           state->on_suspend == (void (*)(struct LLFSMachine *, struct LLFSMState *))fsm_suspend_resume_counter_on_suspend &&
