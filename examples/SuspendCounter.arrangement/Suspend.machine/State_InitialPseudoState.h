...
//
#ifndef LLFSM_SUSPEND_INITIALPSEUDOSTATE_H
#define LLFSM_SUSPEND_INITIALPSEUDOSTATE_H
...
struct FSMSuspend_State_InitialPseudoState
{
...
#endif /* LLFSM_SUSPEND_INITIALPSEUDOSTATE_H */
