...
//        XCTAssertEqual(languageContent, "objc++")
    ...
    static var allTests = [
        ("testCToObjCPPConversion", testCToObjCPPConversion),
        ("testObjCPPToCConversion", testObjCPPToCConversion),
        ("testTrafficLightMachineInResources", testTrafficLightMachineInResources),
        ("testArrangementConversion", testArrangementConversion),
        ("testCodeGenerationVerification", testCodeGenerationVerification)
    ]
}
