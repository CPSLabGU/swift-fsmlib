...
final class CodeGenerationTests: XCTestCase {
    ...
    static var allTests = [
        ...
        ("testCBindingCodeGeneration", testCBindingCodeGeneration),
        ("testCBindingArrangementCodeGeneration", testCBindingArrangementCodeGeneration),
        ("testCMakeGeneration", testCMakeGeneration),
        ("testArrangementCMakeGeneration", testArrangementCMakeGeneration)
    ]
}