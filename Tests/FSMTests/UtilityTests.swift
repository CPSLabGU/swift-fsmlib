...
final class UtilityTests: XCTestCase {
    ...
    static var allTests = [
        ...
        ("testDictionaryExtensions", testDictionaryExtensions),
        ("testRegexUtils", testRegexUtils),
        ("testFileNameHandling", testFileNameHandling),
        ("testFormatHandling", testFormatHandling),
        ("testLanguageBindingEquality", testLanguageBindingEquality)
    ]
}