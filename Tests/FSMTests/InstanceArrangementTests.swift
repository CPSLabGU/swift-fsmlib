...
final class InstanceArrangementTests: XCTestCase {
    ...
    static var allTests = [
        ...
        ("testInstanceEquality", testInstanceEquality),
        ("testArrangementCreation", testArrangementCreation),
        ("testArrangementWrapper", testArrangementWrapper),
        ("testArrangementSerialization", testArrangementSerialization),
        ("testArrangementFromURL", testArrangementFromURL),
        ("testAddingMachinesToArrangement", testAddingMachinesToArrangement)
    ]
}