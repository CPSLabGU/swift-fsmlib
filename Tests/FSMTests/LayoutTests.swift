...
final class LayoutTests: XCTestCase {
    ...
    static var allTests = [
        ("testCoordinate2D", testCoordinate2D),
        ("testRectangle", testRectangle),
        ("testPath", testPath),
        ("testStateLayout", testStateLayout),
        ("testStateLayoutPropertyList", testStateLayoutPropertyList),
        ("testTransitionLayout", testTransitionLayout),
        ("testVectorOperations", testVectorOperations)
    ]
}